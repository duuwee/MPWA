...
<button type="button" id="addbuttonTemp" class="btn btn-primary btn-sm">{{__('Add Button')}}</button>
<button type="button" id="reduceButtonTemp" class="btn btn-danger btn-sm">{{__('Reduce Button')}}</button>
...
window.addEventListener('load', function() {
    ...
    $(document).ready(function() {
        ...
        var add_button = $("#addbuttonTemp"); //Add button ID
        ...
        $(document).on('click', '#reduceButtonTemp', function(e) {
            e.preventDefault();
            if(x > 1){
