        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__('Setting Server')}}</li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="account-tab" data-bs-toggle="tab" data-bs-target="#server"
                            ...
                            aria-selected="true">{{__('Server')}}</button>
                    </li>
								...
								<div class="col-md-12">
									...
									<div class="text-center">
										<form action="{{ route('generateSsl') }}" method="POST">
											...
											@if ($host === 'localhost')
											<button type="submit" class="btn btn-danger btn-sm mt-3" disabled>{{__("You Can't Generate SSL For Localhost")}}</button>
											@else
